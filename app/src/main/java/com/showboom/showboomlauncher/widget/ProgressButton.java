...
public class ProgressButton extends Button {
    ...
    private void init(Context context,AttributeSet attributeSet) {
        ...
        try {
            ...
            int defaultProgressColor = getResources().getColor(R.color.rect_progress);
            ...
            int defaultProgressBgColor = getResources().getColor(R.color.rect_progressbg);
    ...
    private Drawable getNormalDrawable( TypedArray attr) {
        ...
        int defaultNormal =  getResources().getColor(R.color.rect_normal);
    ...
    private Drawable getPressedDrawable( TypedArray attr) {
        ...
        int defaultPressed = getResources().getColor(R.color.rect_pressed);
